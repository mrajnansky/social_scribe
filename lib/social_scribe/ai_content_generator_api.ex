defmodule SocialScribe.AIContentGeneratorApi do
  ...
  @callback generate_contact_suggestions_batch(map(), list(String.t()), list(map())) ::
  ...
  def generate_contact_suggestions_batch(meeting, participant_names, hubspot_fields \\ []) do
    impl().generate_contact_suggestions_batch(meeting, participant_names, hubspot_fields)
  end
